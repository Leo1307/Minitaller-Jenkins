      ...
      steps {
        ...
        withCredentials([usernamePassword(
          ...
          sh '''
            ...
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/leo1307/buscaminas:latest
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/leo1307/buscaminas:${BUILD_NUMBER}
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/leo1307/buscaminas:${GIT_COMMIT_SHORT}

            docker push ghcr.io/leo1307/buscaminas:latest
            docker push ghcr.io/leo1307/buscaminas:${BUILD_NUMBER}
            docker push ghcr.io/leo1307/buscaminas:${GIT_COMMIT_SHORT}
          '''
        }
      }
      post {
